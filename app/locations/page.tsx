...
export default function LocationsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between rounded-2xl border border-teal-200 bg-teal-50/80 px-5 py-4">
        <div>
      ...
      {locations.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-sky-300 bg-sky-50/80 py-20 text-center">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {locations.map((loc) => (
            <Link key={loc.id} href={`/locations/${loc.id}/dashboard`}>
              <Card className="h-full cursor-pointer border-sky-200 bg-sky-50/80 transition-all hover:-translate-y-0.5 hover:bg-sky-100 hover:shadow-md">
                <CardContent className="flex items-start gap-4 p-5">
                  <div className="mt-0.5 rounded-md bg-white p-2 shadow-sm ring-1 ring-sky-200">
                  ...
                  <div className="min-w-0">
                    ...
                    {loc.join_code && (
                      <p className="mt-2 inline-flex rounded-md bg-white/80 px-2 py-1 font-mono text-xs tracking-widest text-sky-700 ring-1 ring-sky-200">
                        Kode: {loc.join_code}
                      </p>
                    )}
                  </div>
