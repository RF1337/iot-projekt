...
function AlertRow({ alert }: { alert: Alert }) {
  ...
  return (
    <TableRow className="transition-colors hover:bg-rose-50/60">
...
export default function AlertsPage() {
  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex items-center justify-between rounded-2xl border border-rose-200 bg-rose-50/75 px-5 py-4">
        <div>
          <h1 className="text-2xl font-bold text-rose-950">Alarmer</h1>
      ...
      <Card className="overflow-hidden border-amber-200 bg-amber-50/50">
        ...
        <CardContent className="divide-y divide-amber-100 bg-white/70 p-0">
          {loading && (
          ...
          {!loading && sensors.length === 0 && (
            <div className="flex flex-col items-center justify-center px-6 py-12 text-center">
              ...
              <p className="text-sm font-semibold text-gray-800">Ingen sensorer</p>
              <p className="mt-1 max-w-xs text-xs text-gray-400">
                Tilføj en enhed under{" "}
          ...
          {sensors.map((sensor) => {
            ...
            return (
              <div key={sensor.id} className="px-5 py-5 space-y-4">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none ${
                        e.enabled ? "bg-primary" : "bg-gray-200"
                      }`}
                      aria-label={e.enabled ? "Slå alarm fra" : "Slå alarm til"}
                    >
                      <span
                ...
                <div className="flex flex-wrap items-center gap-3 border-t border-dashed border-amber-200 pt-3">
                  <div className="flex items-center gap-1.5">
                    <ThermometerSun className="h-4 w-4 text-cyan-500" />
      ...
      <div>
        <h2 className="mb-3 text-sm font-semibold uppercase tracking-wider text-rose-500">
          Alarmhistorik
        </h2>
