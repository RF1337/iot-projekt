...
export default function HistoryPage() {
  ...
  return (
    <div className="w-full space-y-6">
      {/* Header */}
      <div className="flex items-center justify-between rounded-2xl border border-indigo-200 bg-indigo-50/75 px-5 py-4">
        <div>
          <h1 className="text-2xl font-bold text-indigo-950">Historik</h1>
      ...
      <div>
        ...
        {!searched && !loading && (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-indigo-300 bg-indigo-50/80 py-16 text-center">
            <div className="mb-4 rounded-full bg-indigo-100 p-4">
              <CalendarSearch className="h-8 w-8 text-indigo-700" />
            </div>
        ...
        {searched && !loading && allRows.length === 0 && !error && (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-rose-300 bg-rose-50/80 py-16 text-center">
            <div className="mb-4 rounded-full bg-rose-100 p-4">
              <SearchX className="h-8 w-8 text-rose-600" />
            </div>
